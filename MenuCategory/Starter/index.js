    ...
    <View style={{alignSelf:'flex-end', paddingRight:15,padding:10}}>
       <TouchableOpacity onPress={()=>navigation.openDrawer()}>  
        ...
        <ScrollView>
           ...
           <View style={styles.ProductBox}>
              <Text style={styles.ProductName}> French Fries </Text>
                 <Image source={require('../../images/frenchfries.png')}
        ...
        <View style={styles.ProductBox}>
            ...
            <Image source={require('../../images/mozzarela.jpg')}
               style={{width:140, height:140,marginLeft:100,borderRadius:80}}/>
        ...
        <View style={styles.ProductBox}>
            <Text style={styles.ProductName}> Chicken Tenders </Text>
               <Image source={require('../../images/chickentenders.png')}
        ...
        <View style={styles.ProductBox}>
            <Text style={styles.ProductName}> Chicken Wings </Text> 
               <Image source={require('../../images/chickenwings.png')}
                 style={{width:140, height:140,marginLeft:100,borderRadius:80}}/>
